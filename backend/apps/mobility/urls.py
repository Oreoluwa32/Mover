...
from .views import DeliveryRequestViewSet, EmergencyAlertViewSet, MobilityDashboardView, RideRequestViewSet, TrackingSessionViewSet, TravelMatchViewSet, TravelPlanViewSet
...
router.register("delivery-requests", DeliveryRequestViewSet, basename="delivery-request")
