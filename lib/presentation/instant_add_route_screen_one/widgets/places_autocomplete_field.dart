                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                          ...
                          onTap: () async {
                            ...
                            final selectedDetails = ref.read(placesAutocompleteProvider).selectedPlaceDetails;
                            if (selectedDetails != null && widget.onPlaceSelected != null) {
                              widget.onPlaceSelected!(
                                prediction.description,
                                selectedDetails.latitude,
                                selectedDetails.longitude,
                              );
                            }
